...
This sample shows how to establish an AmsTcpIpRouter (together with AdsServer for the Router (AmsPort 1) and SystemService (AmsPort 10000)) and an AdsClient together in one console app.
